...
class NarsumController extends Controller
{
    public function view() {
        ...
        $pegawai = Pegawai::where('jenis', '1')->get();

        return view('admin.narsum.view', compact('pegawai'));
    }
        ...
        if($id_pegawai == null){
            $nomorurut = "000000000001";
        }else{
            $nomorurut = substr($id_pegawai->id_pegawai, 3, 12) + 1;
            $nomorurut = str_pad($nomorurut, 12, "0", STR_PAD_LEFT);
        }
    ...
    public function edit(Request $request){
        ...
        return view('admin.narsum.edit', compact('pegawai'));
