        ...
        @endif
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ Route('perfasilitator')}}">Akomodasi Fasilitator</a></li>
						<li class="breadcrumb-item"> Data Narasumber</li>
					</ol>
                </div>
                <!-- row -->
                 <div class="row">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title">Tambah Narasumber</h3>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="basic-form">
                                                <form action="{{ route('a.narsum')}}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center;">JEBATAN / LEMBAGA / INSTANSI</th>
                                        ...
                                        @foreach ($pegawai as $d)
                                            <tr>
                                                ...
                                                <td style="color: black;"><b>{{ $d->nama }}</b>@if ($d->nip == '-')
                                                 @else  
                                                 <br>{{ $d->pangkgol}}<br>{{ $d->nip}} 
                                                @endif</td>
...
$(document).on('click', '.edit', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '/admin/perjadinfasilitator/narasumber/edit',
        cache: false,
        data: {
            _token: "{{ csrf_token() }}",
...
$(document).on('click', '.hapus', function(){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = "/admin/perjadinfasilitator/narasumber/hapus"+id_pegawai
        }
    });
});
...
$(document).on('click', '.status', function(){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = "/admin/perjadinfasilitator/narasumber/status"+id_pegawai
        }
    });
});
</script>
